                                ...
                                <div className="carousel-item active">
                                    <div className="d-flex  justify-content-end align-items-end position-relative">
                                        ...
                                        >
                                            ...
                                            <p className={`text-3xl md:text-5xl md:leading-[60px] text-dullWhite font-semibold  ${Font.className}`} style={{ letterSpacing: "4%" }}>Up to 10% <br />off Voucher</p>
                                            <Link
                                                href="/"
                                                className="text-dullWhite  mt-2 fw-semibold  text-decoration-none w-fit border-b-[1px] border-b-white hover:text-red"
                                            >
                                                Shop Now →
                                            </Link>
                                        </div>
